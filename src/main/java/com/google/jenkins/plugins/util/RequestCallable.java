...
/**
 * A {@link Callable} that only throws {@link IOException}
 * or {@link ExecutorException}.
 *
...
public abstract class RequestCallable<T> implements Callable<T> {
   ...
   */
  public static <R> RequestCallable<R> from(
      final AbstractGoogleJsonClientRequest<R> request) {
    return new RequestCallable<R>() {

      /** {@inheritDoc} */
      @Override public R call() throws IOException {
